    ...
    public class PgpManager
    {
       ...
       */
        ...
        */
        ...
        /* 
        * A simple routine that opens a key ring file and loads the first available key suitable fors encryption. 
        */

        private static PgpPublicKey ReadPublicKey(Stream inputStream, int bitStrength)
        {
